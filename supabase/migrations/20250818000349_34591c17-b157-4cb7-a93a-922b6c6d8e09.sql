...
-- Enable RLS on clients_secure_view (fixing critical gap)
ALTER TABLE public.clients_secure_view ENABLE ROW LEVEL SECURITY;

-- Add proper RLS policy for clients_secure_view
CREATE POLICY "Agency team can view secure client data" 
ON public.clients_secure_view 
FOR SELECT 
